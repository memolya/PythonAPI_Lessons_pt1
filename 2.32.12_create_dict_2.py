movie_info = ("Название 'Армагеддон', Год выпуска '1998', Продолжительность '144', "
              "Жанр 'Фантастика', Режиссер 'Майкл Бэй', В главных ролях 'Брюс Уиллис', Статус фильма 'Брюса жалко'")
